...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public void startTest() throws RuntimeException{
    ...
    private Student infoStudent() {
        ...
        try {
            ...
            System.out.print(messageSource.getMessage("ms.user.lastName",new String[]{": "} , locale));
    ...
    private void showResultMessage(Student student) {
        System.out.println(messageSource.getMessage("ms.user.name", new String[]{student.getLastName() + ", " + student.getFirstName()}, locale));
